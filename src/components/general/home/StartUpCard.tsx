...
import {
  ...
  CardContainer,
  CardItem,
} from "../../acernityComponents/HoverCards";
import Link from "next/link";
import "../../../components/allStyles.css";

export function ThreeDCardHome() {
  return (
    <CardContainer className="inter-var" data-theme="cupcake">
      <CardBody className=" relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
        <CardItem
          translateZ="50"
          className="text-xl font-bold text-[#13ffaa] dark:text-white"
        >
        ...
        >
          We help you to create your idea to a software solution
        </CardItem>
        <CardItem
          translateZ="100"
          rotateX={20}
